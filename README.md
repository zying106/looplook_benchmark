...
- `analysis/figure_scripts/`: recreates manuscript figures from benchmark outputs. `plot_global_es_forest.R` (Fig 5b / Fig 6b) reads `size200/.es_33mode_cache.rds`, which is generated by `3.generate_es_33mode_cache.R` from the TSS5000 annotation RData, the differential table, and the factor ChIP-seq peaks (hop0, 16 looplook modes + ChIPseeker).
